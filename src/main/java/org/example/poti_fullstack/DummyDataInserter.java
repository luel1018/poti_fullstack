package org.example.poti_fullstack;
...
public class DummyDataInserter {
    ...
    private static final String DB_URL = "jdbc:mariadb://192.168.230.104:3306/test";
    private static final String DB_USER = "test"; // 예: root
    ...
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USER, DB_PASSWORD);
            ...
            for (int i = 1; i <= totalCount; i++) {
                ...
                namecardStmt.setString(4, "https://poti_fullstack.example.com/user" + i); // url
