package org.example.poti_fullstack.community.model;
...
public class CommunityDto {
    ...
    public static class PageRes {
        ...
        public static PageRes from(Page<Community> result, Long loginUserIdx, Set<Long> favoriteIds) {
            return PageRes.builder()
                    .communityList(result.get().map(entity -> ListRes.from(entity, loginUserIdx, favoriteIds.contains(entity.getIdx()))).toList())
        ...
        public static PageRes from(List<Community> result, int page, int size, Long loginUserIdx, Set<Long> favoriteIds) {
            return PageRes.builder()
                    .communityList(result.stream().map(entity -> ListRes.from(entity, loginUserIdx, favoriteIds.contains(entity.getIdx()))).toList())
                    .totalPage(1)
    ...
    public static class ProfileRes {
        ...
        public static ProfileRes from(org.example.poti_fullstack.user.model.User entity) {
